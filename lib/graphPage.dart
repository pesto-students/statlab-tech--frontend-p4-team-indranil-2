      ...
      children: <Widget>[
        Expanded(
          ...
          child: Padding(
            ...
            child: Center(
              child: Text(
                'What kind of graph do you want to plot?.',
              ...
              child: Material(
                ...
                child: InkWell(
                    onTap: () {
                      setState(() {
                        scoreKeeper.add(
                          Icon(Icons.check, color: Colors.purple[900],),
                        );
                      });
            ...
            child: ButtonTheme(
              child: Material(
                ...
                child: InkWell(
                    onTap: () { setState(() {
                      scoreKeeper.add(
                        Icon(Icons.check, color: Colors.indigo[400],),
                      );
                    });},
            ...
            child: ButtonTheme(
              child: Material(
                ...
                child: InkWell(
                    onTap: () { setState(() {
                      scoreKeeper.add(
                        Icon(Icons.check, color: Colors.yellow[900],),
                      );
                    });},
            ...
            child: ButtonTheme(
              child: Material(
                ...
                child: InkWell(
                    onTap: () { setState(() {
                      scoreKeeper.add(
                        Icon(Icons.check, color: Colors.red[900],),
                      );
                    });},
